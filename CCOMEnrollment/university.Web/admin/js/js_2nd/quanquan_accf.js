    ...
    if (items != null && items.length > 0) {
        ...
        for (iii = 0; iii < items.length; iii++) {
            ...
            if ((tmpItem.Type == 'radio' || tmpItem.Type == 'checkbox') && tmpItem.Subitems != null && tmpItem.Subitems.length > 0) {
                if (!tmpItem.Required) htmlTmp += '<input name="items[' + index + '][' + i + '].Value" style="height:0px;width:0px;border:0px;" checked="checked" type="' + tmpItem.Type + '" value="" />';
                else htmlTmp += '<input name="items[' + index + '][' + i + '].Value" style="height:0px;width:0px;border:0px;" class="required" type="' + tmpItem.Type + '" value="" />';
            }
