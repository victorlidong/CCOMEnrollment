...
namespace university.Web.tools
{
    ...
    public class admin_ajax : IHttpHandler, IRequiresSessionState
    {
        ...
        {
            //取得处事类型
            string action = MyRequest.GetQueryString("action");
        ...
        private void sys_channel_load(HttpContext context)
        {
            ...
            //    if (!new BLL.manager_role().Exists(admin_info.role_id, Convert.ToInt32(dr["id"]), MyEnums.ActionEnum.View.ToString()))
            //    {
            //        continue;
            //    }
        ...
        //{
        //    string channelname = MyRequest.GetFormString("channelname");
        //    string oldname = MyRequest.GetFormString("oldname");
        ...
        //    }
        //    //检查是否与站点根目录下的目录同名
        //    Model.siteconfig siteConfig = new BLL.siteconfig().loadConfig(Utils.GetXmlMapPath(MyKeys.FILE_SITE_XML_CONFING));
        ...
        //{
        //    string rewritekey = MyRequest.GetFormString("rewritekey");
        //    string oldkey = MyRequest.GetFormString("oldkey");
        ...
        //{
        //    string username = MyRequest.GetFormString("username");
        //    string oldusername = MyRequest.GetFormString("oldusername");
        //    //如果为Null，退出
        ...
        //        return;
        //    }
        //    Model.userconfig userConfig = new BLL.userconfig().loadConfig(Utils.GetXmlMapPath(MyKeys.FILE_USER_XML_CONFING));
        //    //过滤注册用户名字符
