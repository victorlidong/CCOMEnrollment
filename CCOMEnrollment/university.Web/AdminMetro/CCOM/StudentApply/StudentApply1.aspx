<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentApply1.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.StudentApply.StudentApply1" %>
        ...
        <div id="container" class="row-fluid" style="margin-top: 0px;">
            <div id="main-content" style="margin-left: 0px; margin-bottom: 0 !important;">
                <div class="container-fluid">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>专业方向：<asp:Label ID="lblDirection" runat="server"></asp:Label>
                                                                        <a target="_blank" href="javascript:EditForm('agencyDetail');">详情</a>
                                                                    </td>
                                                ...
                                                <div class="widget-body" style="display: block;">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td align="center">                            
                                &nbsp;
                                 <asp:Button ID="lbtDelete" CssClass="btn btn-delete" OnClientClick="return confirm('确定要删除吗?');void(0);" OnClick="lbtSingleDelete_Click" runat="server" ToolTip='<%# DESEncrypt.Encrypt(Eval("Fm_id").ToString())%>' Text="删除"></asp:Button>
                                                                &nbsp;
                                        ...
                                        <table class="table table-striped table-bordered dataTable">
                                            <tbody>
                                                <tr>
                                                    <td>密码</td>
                                                    <td>
                                                        <asp:TextBox ID="txtPass" TextMode="Password" CssClass="input-medium" runat="server" minlength="2" MaxLength="100" />
                                                        <span class="help-inline"></span></td>
                                                </tr>
                                                <tr>
                                                    <td>确认密码</td>
                                                    <td>
                                                        <asp:TextBox ID="txtPassConfirm" TextMode="Password" CssClass="input-medium" runat="server" minlength="2" MaxLength="100" />
                                                        <span class="help-inline"></span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <div class="row-fluid">
                        <div id="agencyDetail" style="display: none; width: 450px; height: auto; overflow: auto;">
                            <div class="widget blue">
                                <div class="widget-title">
                                    <h4>专业详细信息</h4>
                                </div>
                                <div class="widget-body" style="height:180px; margin-left:-100px">
                                    <div class="controls" id="Details" runat="server">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row-fluid">
                        <div class="form-actions">
                            <asp:Button ID="submit" runat="server" Text="下一步" CssClass="btn btn-success" OnClick="OnClickNextStep" />
                        </div>
                    </div>
                </div>
            </div>
