<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectToPreliminary.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.AEEManage.SelectToPreliminary" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var title = '<%= this.ddlMajor.SelectedItem.Text +"初试一轮情况" %>';
        function myPrint() {
        ...
        <div id="container" class="row-fluid" style="margin-top: 0px;">
            <div id="main-content" style="margin-left: 0px; margin-bottom: 0 !important;">
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span10">
                            <asp:LinkButton ID="SetFirstIn" runat="server" CssClass="btn btn-warning" OnClick="btnSetFirstIn_Click"><i class="icon-plus icon-white"></i>设置初试一轮筛选科目</asp:LinkButton>
                            <a href="javascript:EditForm('edit_prelimary');" class="btn btn-warning"><i class="icon-upload"></i>提交初试二轮名单</a>
                             <a href="#" onclick="myPrint()" class="btn btn-success"><i class="icon-download">打印表格</i></a>
                            <asp:LinkButton ID="ExportExcel" runat="server" CssClass="btn btn-success" OnClick="exportexcel_ServerClick"><i class="icon-external-link icon-white">&nbsp;</i>导出初试一轮情况</asp:LinkButton>
                        ...
                        <div class="span12">
                            ...
                            <asp:Repeater ID="rptList" runat="server">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr id="<%#DESEncrypt.Encrypt(Eval("User_id").ToString())%>" class="">
                                        <td align="center" id="check">
                                            <asp:CheckBox ID="chkId" CssClass="checkall" runat="server" Visible='<%#this.hasPrelimary %>'/>
                                         <%--   <asp:Label ID="chkNo" runat="server"><%#++this.st_index %></asp:Label>--%>
                                            <asp:Label runat="server"><%#getIntoPreliminary(Eval("UP_calculation_status").ToString()) %></asp:Label>
                                      ...
                                      <%--  <td align="left"><%# Eval("UP_CCOM_number").ToString() %></td>
                                        ...
                                        <td align="left"><%# Eval("Efss_score", "{0:#.##}").ToString() %></td>
                                        <td align="left"><%# Eval("Efss_sequence", "{0:#.##}").ToString() %></td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                        ...
                        <div id="edit_prelimary" style="display: none; width: 450px; height: auto;">
                            <div class="widget blue">
                                ...
                                <div class="widget-body">
                                    <div class="row-fluid">
                                        <span style="text-align:center; font-size:15px; font-weight:bolder;">名单一旦提交，不能再次更改，请您核对正确后提交！！</span>
                                    </div>
                                    <div class="row-fluid">
                                        <div class="form-actions">
                                             <asp:LinkButton ID="btnCalculation" runat="server" CssClass="btn btn-success" OnClick="btnSelectRetrial_Click"><i class="icon-upload">确认提交初试二轮名单</i></asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                            </div>
