<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AEEScoreList.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.AEEManage.AEEScoreList" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="/metro/js/data-js/data-horse.js"></script>
       <script type="text/javascript">
           var title = '<%= this.ddlMajor.SelectedItem.Text +"艺考科目成绩情况" %>';
           function myPrint() {
        ...
        <div id="container" class="row-fluid" style="margin-top: 0px;">
            <div id="main-content" style="margin-left: 0px; margin-bottom: 0 !important;">
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span10">
                         <asp:LinkButton ID="btnCalculation" runat="server" CssClass="btn btn-warning" OnClick="btnCalAEEScore_Click"><i class="icon-upload">计算艺考总成绩</i></asp:LinkButton>
