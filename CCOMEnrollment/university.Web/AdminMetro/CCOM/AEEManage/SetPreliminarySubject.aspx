<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetPreliminarySubject.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.AEEManage.SetPreliminarySubject" %>
                           ...
                           <div class="control-group">
                            ...
                            <div class="control-group">
                             ...
                             <div class="form-actions" style="border-top: none;margin-bottom: 50px;">
                                 ...
                                 <a href="javascript:EditForm('edit_prelimary');" class="btn btn-success"><i class="icon-upload"></i>提交复试科目</a>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div class="row-fluid">
                                        <div class="form-actions">
                                            <asp:LinkButton ID="lblSubmit" runat="server" OnClick="btnSubmit_Click" CssClass="btn btn-success" >确认提交复试科目</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                            </div>
