<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddManager.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.ManagerManage.AddManager" %>
...
<head runat="server">
    ...
    <title><%=(action == MyEnums.ActionEnum.Edit.ToString())?"编辑":"添加"%>管理员</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <h3 class="page-title"><%=(action == MyEnums.ActionEnum.Edit.ToString())?"编辑":"添加"%>管理员
                            </h3>
                    ...
                    <div class="row-fluid" id="contentTab">
                        <div class="span12 tab_con first-tab">
                            ...
                            <div class="splitForm" id="rightForm" style="visibility:hidden">
                                <div class="control-group">
