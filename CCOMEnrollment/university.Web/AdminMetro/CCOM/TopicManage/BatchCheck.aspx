<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchCheck.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.TopicManage.BatchCheck" %>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; width:100% ">
                                          ...
                                          <asp:Button ID="Button1" runat="server" Text="通过" CssClass="btn btn-success" OnClick="btnSubmit_Success" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="Button2" runat="server" Text="不通过" CssClass="btn btn-error" OnClick="btnSubmit_Error" />
                                    </td>
