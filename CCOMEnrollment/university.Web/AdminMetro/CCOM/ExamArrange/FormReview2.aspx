<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormReview2.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.ExamArrange.FormReview2" %>
                    ...
                    <div id="Div1" class="row-fluid" runat="server">
                        <div class="span12">
                            <table class="table table-striped table-bordered dataTable">
                                <tbody><%--colspan="6"--%>
                                    <%--<tr>
                                        <td style="width:10%">论文封皮</td>
                                        <td style="width:2%">
                                            <select runat="server" id="ddl1" style="width:120px" onchange="">
                                                <option value="0">不存在项目</option>
                                                <option value="1">合格</option>
                                                <option value="2">不合格</option>
                                            </select>
                                        </td>
                                        <td style="width:10%">答辩委员会名单及签字</td>
                                        <td style="width:2%">
                                            <select runat="server" id="ddl2" style="width:120px">
                                                <option value="0">不存在项目</option>
                                                <option value="1">合格</option>
                                                <option value="2">不合格</option>
                                            </select>
                                        </td>
                                        <td style="width:10%">正文格式</td>
                                        <td style="width:2%">
                                            <select runat="server" id="ddl3" style="width:120px">
                                                <option value="0">不存在项目</option>
                                                <option value="1">合格</option>
                                                <option value="2">不合格</option>
                                            </select>
