...
{
    public partial class FormReview2 : university.UI.ManagePage
    {
        ...
        {
            var form_models = new BLL.CCOM.Form().GetModelList(" Form_page=2");
        ...
        {
            var review_model = new BLL.CCOM.Form_review().GetModel(" User_id=" + studentID + " and Form_type_id=2");
