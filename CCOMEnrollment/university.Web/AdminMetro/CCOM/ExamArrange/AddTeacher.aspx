<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTeacher.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.ExamArrange.AddTeacher" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function batchAdd() {
            ...
            if (value == "") {
                topWin.jsprint("请选择需要添加的老师", "", "Warning");
                return;
            }
            $.ajax({
                type: "GET",
        ...
        function batchRemove() {
            ...
            if (value == "") {
                topWin.jsprint("请选择需要移除的老师", "", "Warning");
                return;
            }
            $.ajax({
                type: "GET",
                            ...
                            <asp:Repeater ID="rptList" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                           <%-- <a href="javascript:void(0);" onclick='addTeacher("<%#DESEncrypt.Encrypt(Eval("User_id").ToString())%>")'>添加</a>--%>
                                               &nbsp;<a href="javascript:void(0);" onclick='addTeacher(<%#Eval("User_id")%>)'>添加</a>
                                            &nbsp;&nbsp;
                                            <a href="javascript:void(0);" onclick='removeTeacher(<%#Eval("User_id")%>)'>移除</a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
