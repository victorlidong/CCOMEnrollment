...
{
    public partial class AddStudent : university.UI.ManagePage
    {
        ...
        {
            this.fun_id = get_fun_id("CCOM/ExamArrange/AddStudent.aspx");
        ...
        private void RptBind(string _strWhere, string _order)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("AddStudent.aspx", "fun_id={0}&id={1}&keywords={2}&page={3}",MyRequest.GetQueryString("fun_id"), MyRequest.GetQueryString("id"),this.keywords, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("AddStudent.aspx", "fun_id={0}&keywords={1}&id={2}",MyRequest.GetQueryString("fun_id"), txtKeywords.Text, MyRequest.GetQueryString("id")));
        }
