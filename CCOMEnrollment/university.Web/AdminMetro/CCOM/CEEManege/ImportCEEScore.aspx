<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportCEEScore.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.CEEManege.ImportCEEScore" %>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="form-actions">
                                ...
                                &nbsp;
                                <asp:Button ID="btnSubmit"  Visible="False" runat="server" Text="查看高考分数" CssClass="btn btn-success" OnClick="btnSubmit_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                        ...
                        <div class="span12">
                            <div class="alert alert-block alert-info fade in">
                                ...
                                <p>
                                    1.请先下载Excel模板填写相关信息；
                            <br>
                                    2.EXCEL模板中，考生号、姓名和文理类别是必填字段；　
                            <br>
                                    3.文理类别只能填写数字， 1--文， 2--理；
                            <br>
                                    4.分数填写支持小数，为空时默认是0；
                                </p>
                            </div>
