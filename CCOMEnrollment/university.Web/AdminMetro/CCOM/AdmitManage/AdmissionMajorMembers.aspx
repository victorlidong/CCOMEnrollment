<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmissionMajorMembers.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.AdmitManage.AdmissionMajorMembers" %>
...
<head runat="server">
    ...
    <title><%=GetAgencyName(this.major_id.ToString())%>录取名单</title>
    <!--#include file="/metro/include/header_common.html"-->
               <script type="text/javascript">
                   var title = '<%= GetAgencyName(this.major_id.ToString()) +"录取名单" %>';
                   function myPrint() {
                ...
                <div class="container-fluid">
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <h3 class="page-title"><%=GetAgencyName(this.major_id.ToString())%>录取名单
                            </h3>
                            <%-- 
                            <ul class="breadcrumb">
                                <li>
