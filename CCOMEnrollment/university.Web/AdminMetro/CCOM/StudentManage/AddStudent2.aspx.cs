...
{
    public partial class AddStudent2 : university.UI.ManagePage
    {
        ...
        {
            BLL.CCOM.Title bll = new BLL.CCOM.Title();
            ...
            this.ddlIdType.DataTextField = "Title_name";
            this.ddlIdType.DataValueField = "Title_id";
            this.ddlIdType.DataBind();
            ListItem item = new ListItem("--教师须填--", "#");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (result == "")
            {
                JscriptMsg(action == MyEnums.ActionEnum.Edit.ToString() ? "修改成功" : "添加成功", "StudentList.aspx", "Success");
