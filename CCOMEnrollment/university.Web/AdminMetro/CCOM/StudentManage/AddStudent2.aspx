<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStudent2.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.StudentManage.AddStudent2" %>
                    ...
                    <div class="row-fluid" id="contentTab">
                        <div class="span12 tab_con first-tab">
                            <div class="splitForm" id="leftForm">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="txtTitle"><b style="color: red;">*</b>性别</label>
                                    <div class="controls">
                            ...
                            <div class="splitForm" id="rightForm" >
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="txtBirthday" runat="server" class="txtInput normal dateISO"  onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd' })"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="txtTitle">职称</label>
                                    <div class="controls">
