<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherChoose.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.ExamArrange.MyStudentList" %>
                            ...
                            <asp:Repeater ID="rptList" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr>
                                         ...
                                         <td style="text-align:center;">
                                            <a href="./Achievement_degree.aspx?studentID=<%#DESEncrypt.Encrypt( Eval("Student_id").ToString())%>">打分</a>
                                         </td>
                                         <td style="text-align:center;">
                                            <a href="./Tracking_evaluation.aspx?studentID=<%#DESEncrypt.Encrypt( Eval("Student_id").ToString())%>">打分</a>
                                         </td>
                                        <td style="text-align:center;">
                                            <a href="../ScoreManage/TeacherComment.aspx?studentID=<%#DESEncrypt.Encrypt( Eval("Student_id").ToString())%>">打分</a>
                                         </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
