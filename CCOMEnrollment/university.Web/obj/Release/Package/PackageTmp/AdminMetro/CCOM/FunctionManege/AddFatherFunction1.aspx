<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFatherFunction1.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.AddFatherFunction1" %>
                    ...
                    <div class="row-fluid" id="contentTab">
                        <div class="span12 tab_con first-tab">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                     <asp:DropDownList ID="ddlFf_ID" runat="server" CssClass="select2" />
                                </div>
                            </div>       
                            <div class="control-group">
                                <label class="control-label" for="txtTitle"><b style="color: red;">*</b>二级功能名称</label>
                                <div class="controls">
                                    <asp:TextBox ID="txtTitle" runat="server" CssClass="span2 " minlength="2" MaxLength="40" required />
                                </div>
                            </div>          
                            <div class="control-group">
                                <label class="control-label" for="txtSort"><b style="color: red;">*</b>二级功能序号</label>
                                <div class="controls">
                                    <asp:TextBox ID="txtSort" placeholer="请填入数字（如：1）" runat="server" CssClass="span2 " minlength="1" MaxLength="50" required />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><b style="color: red;">*</b>二级功能状态</label>
