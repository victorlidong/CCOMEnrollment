<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScoreList.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.ScoreManage.ScoreList" %>
                            ...
                            <asp:Repeater ID="rptList" runat="server">
                                        ...
                                        <thead>
                                            <tr>
                                                <th width="5%" >序号</th>
                                                 ...
                                                 <th style="width: 15%;">指导教师评分</th>
                                                 <th style="width: 10%;">口头答辩成绩</th>
                                                 <th style="width: 10%;">软件验收成绩</th>
                                                 <th style="width: 10%;">最终成绩</th>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><%#GetCommentScore(long.Parse(Eval("User_id").ToString()),1)%></td>
                                        <td style="text-align: center;"><%#GetCommentScore(long.Parse(Eval("User_id").ToString()),2)%></td>
                                        <td style="text-align: center;"><%#GetSoftwareScore(long.Parse(Eval("User_id").ToString()))%></td>
                                        <td style="text-align: center;"><%#GetScore(long.Parse(Eval("User_id").ToString()))%></td>
                                       <td style="text-align: center;"> 
                                            <a href="CommentPage.aspx?userId=<%#DESEncrypt.Encrypt( Eval("User_id").ToString())%>&fun_id=<%=DESEncrypt.Encrypt("15") %>" >答辩评语表</a>
                                            &nbsp;
                                           <a href="SoftwarePage.aspx?userId=<%#DESEncrypt.Encrypt( Eval("User_id").ToString())%>&fun_id=<%=DESEncrypt.Encrypt("15") %>" >软件验收表</a>
                                        </td> 
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
