<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherComment.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.ScoreManage.TeacherComment" %>
                        ...
                        <div class="span12">
                            <table class="table table-striped table-bordered dataTable">
                                <tbody><%--colspan="4"--%>
                                    ...
                                    <tr>
                                        <td colspan="2">答辩委员会（小组）给定的成绩：</td>
                                        <td colspan="2">
