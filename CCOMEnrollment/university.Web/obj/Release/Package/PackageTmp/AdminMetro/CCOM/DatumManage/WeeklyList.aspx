<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeeklyList.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.DatumManage.WeeklyList" %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid" id="contentTab">
                        ...
                        <div class="span12 tab_con first-tab" style="height:200px;">
                            <a href="WeeklyAdd.aspx?action=<%=MyEnums.ActionEnum.Add.ToString() %>&fun_id=<%=DESEncrypt.Encrypt("15") %>" class="btn btn-success">添加用户提交</a>
