<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSonFunction.aspx.cs" Inherits="university.Web.AdminMetro.CCOM.AddSonFunction" %>
                    ...
                    <div class="row-fluid" id="contentTab">
                        <div class="span12 tab_con first-tab">
                            <div class="control-group">
                                <label class="control-label" for="txtFather"><b style="color: red;">*</b>一级父功能</label>
                                <div class="controls">
                                     <asp:DropDownList ID="ddlFf1_ID" runat="server" CssClass="select2" AutoPostBack="True" OnSelectedIndexChanged="ddlFf1_ID_SelectedIndexChanged" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="txtFather"><b style="color: red;">*</b>二级父功能</label>
                                <div class="controls">
                                <asp:DropDownList ID="ddlFf2_ID" runat="server" CssClass="select2">
                                    <asp:ListItem Value="#">--请选择二级父功能--</asp:ListItem>
                                </asp:DropDownList>
                                </div>
                            </div>             
                            <div class="control-group">
                                <label class="control-label" for="txtTitle"><b style="color: red;">*</b>子功能名称</label>
                                <div class="controls">
                                    <asp:TextBox ID="txtTitle" runat="server" CssClass="span2 " minlength="2" MaxLength="40" required />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="txtURL"><b style="color: red;">*</b>子功能链接</label>
                                <div class="controls">
                                    <asp:TextBox ID="txtURL" runat="server" CssClass="span2 " minlength="2" MaxLength="128" required />
                                </div>
                            </div>           
                            <div class="control-group">
                                <label class="control-label" for="txtSort"><b style="color: red;">*</b>子功能序号</label>
                                <div class="controls">
                                    <asp:TextBox ID="txtSort" placeholer="请填入数字（如：1）" runat="server" CssClass="span2 " minlength="1" MaxLength="50" required />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><b style="color: red;">*</b>子功能状态</label>
