...
(function($, undefined)
{
	...
	p.init = function(input, opts)
	{
		...
		self.originalHeight = input.outerHeight();
	...
	p.invalidateBounds = function()
	{
		...
		height_o=self.originalHeight + 'px',
		...
		input.css({ 'width' : width,'height' : height_o});
		wrap.css({ 'width' : width, 'height' : height_o});
		container.css({ 'height' : height_o}); 
		// if(height_value<100){
			// wrap.css({ 'width' : width, 'height' : height,'overflow-y':'','border-bottom':''});
			// container.css({ 'height' : height}); 
		// }else{
			// wrap.css({ 'width' : width_wrap, 'height' : '100px','overflow-y':'scroll','border-bottom':'solid 1px #e2e6f0'});
