...
namespace university.BLL.CCOM
{
	...
	{
		private readonly university.DAL.CCOM.Reply_commission dal=new university.DAL.CCOM.Reply_commission();
		...
		/// 得到一个对象实体，从缓存中
        ///// </summary>
        //public university.Model.CCOM.Reply_commission GetModelByCache(long Rc_id)
        //{
			
        //    string CacheKey = "Reply_commissionModel-" + Rc_id;
        ...
        //        catch{}
        //    }
        //    return (university.Model.CCOM.Reply_commission)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.Reply_commission> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.Reply_commission> DataTableToList(DataTable dt)
		{
			List<university.Model.CCOM.Reply_commission> modelList = new List<university.Model.CCOM.Reply_commission>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				university.Model.CCOM.Reply_commission model;
