...
namespace university.BLL.CCOM
{
	...
	{
		private readonly university.DAL.CCOM.Comment dal=new university.DAL.CCOM.Comment();
		public Comment()
		{}
		#region  BasicMethod
		/// <summary>
		...
		{
            return dal.DeleteList(Comment_idlist);
		}
		...
		public university.Model.CCOM.Comment GetModel(long Comment_id)
		{
			...
			return dal.GetModel(Comment_id);
		}
        /// <summary>
        /// 得到一个对象实体
        /// </summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public university.Model.CCOM.Comment GetModelByCache(long Comment_id)
        //{
			
        //    string CacheKey = "CommentModel-" + Comment_id;
        //    object objModel = university.Common.DataCache.GetCache(CacheKey);
        //    if (objModel == null)
        //    {
        //        try
        //        {
        //            objModel = dal.GetModel(Comment_id);
        //            if (objModel != null)
        //            {
        ...
        //        catch{}
        //    }
        //    return (university.Model.CCOM.Comment)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.Comment> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.Comment> DataTableToList(DataTable dt)
		{
			List<university.Model.CCOM.Comment> modelList = new List<university.Model.CCOM.Comment>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				university.Model.CCOM.Comment model;
