...
namespace university.BLL.CCOM
{
	...
	{
		private readonly university.DAL.CCOM.View_Selete_Topic dal=new university.DAL.CCOM.View_Selete_Topic();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public university.Model.CCOM.View_Selete_Topic GetModelByCache()
        //{
        //    //该表无主键信息，请自定义主键/条件字段
        //    string CacheKey = "View_Selete_TopicModel-" ;
        ...
        //        catch{}
        //    }
        //    return (university.Model.CCOM.View_Selete_Topic)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.View_Selete_Topic> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.View_Selete_Topic> DataTableToList(DataTable dt)
		{
			List<university.Model.CCOM.View_Selete_Topic> modelList = new List<university.Model.CCOM.View_Selete_Topic>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				university.Model.CCOM.View_Selete_Topic model;
