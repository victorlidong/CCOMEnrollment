...
namespace university.BLL.CCOM{
		...
		public partial class View_GetExaminee
	{
		...
		private readonly university.DAL.CCOM.View_GetExaminee dal=new university.DAL.CCOM.View_GetExaminee();
		public View_GetExaminee()
		{}
		...
		/// </summary>
		/*
		public university.Model.CCOM.View_GetExaminee GetModelByCache()
		{
			
			string CacheKey = "View_GetExamineeModel-" + ;
			...
			return (university.Model.CCOM.View_GetExaminee)objModel;
		}*/
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.View_GetExaminee> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.View_GetExaminee> DataTableToList(DataTable dt)
		{
			List<university.Model.CCOM.View_GetExaminee> modelList = new List<university.Model.CCOM.View_GetExaminee>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				university.Model.CCOM.View_GetExaminee model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new university.Model.CCOM.View_GetExaminee();					
