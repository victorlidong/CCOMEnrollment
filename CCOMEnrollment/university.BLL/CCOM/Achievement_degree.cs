...
namespace university.BLL.CCOM
{
	...
	{
		private readonly university.DAL.CCOM.Achievement_degree dal=new university.DAL.CCOM.Achievement_degree();
		...
		{
            return dal.DeleteList(Ac_idlist);
		}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public university.Model.CCOM.Achievement_degree GetModelByCache(long Ac_id)
        //{
			
        //    string CacheKey = "Achievement_degreeModel-" + Ac_id;
        ...
        //        catch{}
        //    }
        //    return (university.Model.CCOM.Achievement_degree)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.Achievement_degree> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.Achievement_degree> DataTableToList(DataTable dt)
		{
			List<university.Model.CCOM.Achievement_degree> modelList = new List<university.Model.CCOM.Achievement_degree>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				university.Model.CCOM.Achievement_degree model;
