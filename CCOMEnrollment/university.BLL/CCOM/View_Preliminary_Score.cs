...
namespace university.BLL.CCOM{
		...
		public partial class View_Preliminary_Score
	{
		...
		private readonly university.DAL.CCOM.View_Preliminary_Score dal=new university.DAL.CCOM.View_Preliminary_Score();
		public View_Preliminary_Score()
		{}
		...
		/// </summary>
		/*
		public university.Model.CCOM.View_Preliminary_Score GetModelByCache()
		{
			
			string CacheKey = "View_Preliminary_ScoreModel-" + ;
			...
			return (university.Model.CCOM.View_Preliminary_Score)objModel;
		}*/
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.View_Preliminary_Score> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<university.Model.CCOM.View_Preliminary_Score> DataTableToList(DataTable dt)
		{
			List<university.Model.CCOM.View_Preliminary_Score> modelList = new List<university.Model.CCOM.View_Preliminary_Score>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				university.Model.CCOM.View_Preliminary_Score model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new university.Model.CCOM.View_Preliminary_Score();					
