...
namespace university.Database
{
    public abstract class DBSQL
    {
        ...
        public static string connectionString =ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
            //DESEncrypt.Decrypt(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        public DBSQL() { }
        ...
        public static int GetMinID(string FieldName, string TableName)
        {
            ...
            object obj = DBSQL.GetSingle(strsql);
            if (obj == null)
            {
                return 0;
            }
        ...
        {
            object obj = DBSQL.GetSingle(strSql, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
