...
namespace university.Common
{
	...
	public class Thumbnail
	{
        ...
        /// <param name="height">缩略图高度</param>
        /// <param name="mode">生成缩略图的方式</param>    
        /// <param name="limited">是否限制为原图的最大宽高</param>  
        public static void MakeThumbnailImage(string fileName, string newFileName, int width, int height, string mode,bool limited)
        {
            Image originalImage = Image.FromFile(fileName);
            int x = 0;
            int y = 0;
