...
namespace university.DAL.CCOM
{
	...
	public partial class Form
	{
		...
		public int GetMaxId()
		{
		return DBSQL.GetMaxID("Form_id", "Form"); 
		}
		...
		public bool Exists(int Form_id)
		{
			...
			strSql.Append("select count(1) from Form");
		...
		public bool Delete(int Form_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Form ");
			strSql.Append(" where Form_id=@Form_id");
			SqlParameter[] parameters = {
					new SqlParameter("@Form_id", SqlDbType.Int,4)
			};
		...
		public bool DeleteList(string Form_idlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Form ");
			strSql.Append(" where Form_id in ("+Form_idlist + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Form_id,Form_name,Form_page,Ff_id ");
			strSql.Append(" FROM Form ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Form_id,Form_name,Form_page,Ff_id ");
			strSql.Append(" FROM Form ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.Form_id desc");
			}
			strSql.Append(")AS Row, T.*  from Form T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Form";
			parameters[1].Value = "Form_id";
