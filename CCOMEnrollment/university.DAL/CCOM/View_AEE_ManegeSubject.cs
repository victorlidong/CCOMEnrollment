...
namespace university.DAL.CCOM
{
		...
		public partial class View_AEE_ManegeSubject
	{
		...
		public bool Exists()
		{
			...
			strSql.Append("select count(1) from View_AEE_ManegeSubject");
			strSql.Append(" where ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into View_AEE_ManegeSubject(");			
            strSql.Append("User_id,Period_id,Subject_id,Subject_title,Subject_level,Major_Agency_id,Ea_id,Manage_Agency_id");
            ...
            parameters[3].Value = model.Subject_title;                        
            parameters[4].Value = model.Subject_level;                        
            parameters[5].Value = model.Major_Agency_id;                        
            parameters[6].Value = model.Ea_id;                        
            parameters[7].Value = model.Manage_Agency_id;                        
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update View_AEE_ManegeSubject set ");
...
SqlParameter[] parameters = {
		...
		public bool Delete()
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from View_AEE_ManegeSubject ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};
		...
		public university.Model.CCOM.View_AEE_ManegeSubject GetModel()
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select User_id, Period_id, Subject_id, Subject_title, Subject_level, Major_Agency_id, Ea_id, Manage_Agency_id  ");			
			strSql.Append("  from View_AEE_ManegeSubject ");
			strSql.Append(" where ");
						SqlParameter[] parameters = {
			};

			
			university.Model.CCOM.View_AEE_ManegeSubject model=new university.Model.CCOM.View_AEE_ManegeSubject();
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from View_AEE_ManegeSubject T ");
